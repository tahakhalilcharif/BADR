...
@section('content-emp')
    ...
    <div class="container-add">
        <form action="{{ route('employee.store_client') }}" method="POST">
            ...
            <div id="typeFields" class="mb-3" style="display: none;">
            ...
            <div id="formeJuridiqueFields" class="mb-3" style="display: none;">
            ...
            <div id="denominationFields" class="mb-3" style="display: none;">
            ...
            <div id="activiteFields" class="mb-3" style="display: none;">
